...
ES_Travel_Frame.dng:SetNormalAtlas("TaxiNode_Continent_Neutral")
ES_Travel_Frame.dng:SetHighlightAtlas("TaxiNode_Continent_Alliance")
ES_Travel_Frame.dng:SetPushedAtlas("TaxiNode_Continent_Alliance")
...
ES_Travel_Dungeon.ret:SetNormalAtlas("poi-traveldirections-arrow2")
ES_Travel_Dungeon.ret:SetHighlightAtlas("poi-traveldirections-arrow")
ES_Travel_Dungeon.ret:SetPushedAtlas("poi-traveldirections-arrow2")
